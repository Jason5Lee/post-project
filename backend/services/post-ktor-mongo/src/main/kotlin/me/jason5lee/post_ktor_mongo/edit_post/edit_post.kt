...
abstract class Workflow {
    suspend fun run(caller: UserId, input: Command): Result<Unit, Failures> =
    ...
    abstract suspend fun updatePost(post: PostId, newContent: PostContent): Result<Unit, Failures>
}
